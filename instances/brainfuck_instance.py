...
class BrainfuckInstance(ProjectInstance):
    def __init__(self, name, bot):
        ...
        self.output_hex = False             #make a config option *********************************************
        ...
        self.bf_interpreter = BrainfuckInterpreter(self.use_16bit, self.input_mode, self.use_hex, self.use_extra, self.use_meta, self.max_iterations)
